...
const SectorPerformance = ({
    ...
    return (
        <Container className="sector_container">
            ...
            <Row className="sector_row">
                <Col className="sector_heading" xs={12} sm={6}>Consumer Defensive: </Col>
            ...
            <Row className="sector_row">
                <Col className="sector_heading" xs={12} sm={6}>Financial Services: </Col>
            ...
            <Row className="sector_row" >
                <Col className="sector_heading" xs={12} sm={6}>Industrial Goods: </Col>

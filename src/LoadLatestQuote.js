...
const LoadLatestQuote = ({
    ...
    return (
        <ReactCardFlip isFlipped={isFlipped} flipDirection="vertical">
            <div className="front mt-4" onClick={handleClick}>
                ...
                <div className="flex-item"><button className="button-front btn" onClick={handleClick}>Show</button></div>
            </div>
            <div className="back" onClick={handleClick}>
                ...
                <div className="flex-item-back">
                    <button className="button-back btn" onClick={handleClick}>Back</button>
                </div>
            </div>
        </ReactCardFlip>
    )
